 ...
 *
 * Server Component — renderiza produtos via Wix Stores API.
 * Ordenação e query são mantidos na URL (?q=&sort=) para
      ...
      <Link
        ...
        <div className="relative aspect-3/4 bg-rose-soft rounded-2xl overflow-hidden mb-3">
          {product.media[0]?.url ? (
            ...
            /* Placeholder com padrão de pontos da marca */
  ...
  return (
    <main className="min-h-[60vh]">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Barra de controles: contagem + ordenação */}
        {products.length > 0 && (
          <div
            ...
            {/* SortSelect precisa de Suspense pois usa useSearchParams */}
            <Suspense
              fallback={
        ...
        {/* Estados: vazio com query / vazio sem query / grid */}
