/**
 * Página da categoria Maquiagem — /maquiagem
 */
...
export const metadata: Metadata = {
  title: "Maquiagem | Belezuura",
  description: "Os melhores produtos de maquiagem na Belezuura.",
};
...
export default async function MaquiagemPage({
  searchParams,
}: {
