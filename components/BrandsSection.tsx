...
const BRANDS = [
  ...
  {
    name: "ZARA",
    className: `${fontZara.className} tracking-[0.2em] font-bold italic`,
  }, // Approximating the overlap look with italic/spacing? No, just keep it clean.
  { name: "GUCCI", className: `${fontVersace.className} tracking-[0.1em]` },
  {
    name: "PRADA",
    className: `${fontPrada.className} font-bold tracking-wider`,
  },
  {
    name: "Calvin Klein",
    className: `${fontCK.className} tracking-tight font-light text-xl`,
  },
];
...
export default function BrandsSection() {
  return (
    <section
      ...
      aria-label="Brands">
      <div className="max-w-site-container mx-auto px-4">
        {/*
